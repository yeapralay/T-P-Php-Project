...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul class="menu">
          ...
          <li><a href="#">Login</a>
          		<ul>
                	<li class="active"><a href="student_login.php">Student</a></li>
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <form name="frm" action="slog_code.php" method="post" enctype="multipart/form-data">
...
<tr>
<td align="center"><input type="submit" name="log" value="Login" id="btn" /><a href="student_reg.php">New Registration</a></td></tr>
