        ...
        <ul class="menu">
          ...
          <li><a href="#">Settings</a>
          		<ul>
                    ...
                    <li class="active"><a href="student_pwd.php">Password</a></li>
                </ul>
          </li>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content1">
		  	<form id="pwd" name="pwd" action="student_pwd_code.php" method="post" enctype="multipart/form-data">
			<table cellpadding="5" cellspacing="5" style="width:auto">
			<tr><td>Old Password</td>
				<td><input type="password" name="oldpwd" placeholder="Password" 
                     id="pwd"/></td></tr>
				<tr><td>New Password</td>
					<td><input type="password" name="npwd" placeholder="Password"
                          id="npwd" /></td></tr>
				<tr><td>Confirm Password</td>
				<td><input type="password" name="cpwd" placeholder="Confirm Password"                     id="cpwd" onchange="return conpwd();" /></td></tr>
					<tr><input type="hidden" name="sid" value="<?php echo $_SESSION['suser_info']['sid'] ?>" /><td colspan="2" align="center"><input type="submit" name="pwd" value="Change Password" /></td></tr>
