      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <?php
			...
			?>
			<form action="admin_profile_code.php" method="post" name="profile" enctype="multipart/form-data">
<table cellpadding="3" cellspacing="5">
<tr>
<td>Email</td>
<td>
<input type="text" name="user" value="<?php echo $row['user'] ?>"  required/></td></tr>
<tr>
<td>Name</td>
<td>
<input type="text" name="uname" value="<?php echo $row['uname'] ?>"  required/></td></tr>
<tr>
