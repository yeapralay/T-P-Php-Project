    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul class="menu">
          ...
          <li ><a href="company_student_info.php"><span>Student</span></a></li>
          <li class="active"><a href=""><span>Password</span></a></li>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content1">
		  	<form id="pwd" name="pwd" action="company_pwd_code.php" method="post" enctype="multipart/form-data">
			...
			<tr><td>Old Password</td>
				...
				<td><input type="password" name="cpwd" placeholder="Confirm Password" id="cpwd" onchange="return conpwd();" /></td></tr>
					<tr><input type="hidden" name="cid" value="<?php echo $_SESSION['cuser_info']['cid'] ?>" /><td colspan="2" align="center"><input type="submit" name="pwd" value="Change Password" /></td></tr>
