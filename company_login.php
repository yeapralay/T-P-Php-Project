...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul class="menu">
          ...
          <li><a href="student_login.php">Login</a>
          		<ul>
                	<li><a href="student_login.php">Student</a></li>
                    <li class="active"><a href="company_login.php">Company</a></li>
                </ul>
          </li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   <div class="article">
          <h2><span>COMPANY LOGIN</span></h2>
	  <form name="frm" action="clog_code.php" method="post" enctype="multipart/form-data">
...
<tr>
<td align="center"><input type="submit" name="log" value="Login" id="btn" />
