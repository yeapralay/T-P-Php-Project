    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <form name="frm" id="frm" action="cv_code.php" method="post" enctype="multipart/form-data">
		  <table cellpadding="5" cellspacing="5">
		  <tr><td>
			<input type="file" name="cv" /></td><td><input type="submit" name="ok" value="Upload" /></td></tr>
		</table>
		</form>
		<?php
			if(isset($_GET['msg']))
